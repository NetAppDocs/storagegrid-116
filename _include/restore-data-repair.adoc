...
If all storage volumes have failed, repair the entire node. Use either or both of the following commands, based on whether you use *replicated data*, *erasure-coded (EC) data*, or both.
...
If only some of the volumes have failed, repair the affected volumes. Use either or both of the following commands, based on whether you use *replicated data*, *erasure-coded (EC) data*, or both.
