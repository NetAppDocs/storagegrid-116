---
permalink: admin/concept_configuring_administrator_client_certificates.html
sidebar: sidebar
keywords: 
summary: ''
---
 ...
 ** To upload a certificate, go to step link:concept_configuring_administrator_client_certificates.md#STEP_UPLOAD_CERT[concept_configuring_administrator_client_certificates.md#STEP_UPLOAD_CERT].
 ** To generate a certificate, go to step link:concept_configuring_administrator_client_certificates.md#STEP_GEN_CERT[concept_configuring_administrator_client_certificates.md#STEP_GEN_CERT].
