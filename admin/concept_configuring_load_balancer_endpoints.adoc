---
permalink: admin/concept_configuring_load_balancer_endpoints.html
sidebar: sidebar
keywords: 
summary: ''
---
...
xref:task_configuring_s3_api_endpoint_domain_names.adoc[Configuring S3 API endpoint domain names]
 ...
 .. Select image:../media/plus_sign_black_on_white.gif[Plus Sign] to add any other domain names or IP addresses.
+
