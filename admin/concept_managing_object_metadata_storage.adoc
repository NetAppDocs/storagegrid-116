---
permalink: admin/concept_managing_object_metadata_storage.html
sidebar: sidebar
keywords: 
...
. From the Grid Manager, select *Nodes* > *Storage Node*.
...
. From the Grid Manager, select *Node* > *Storage Node*.
. Select the *Storage* tab.
...
To learn how to monitor the object metadata capacity for each Storage Node, see the instructions for monitoring and troubleshooting StorageGRID.

To increase the object metadata capacity for your system, you must add new Storage Nodes. See the instructions for expanding StorageGRID.
