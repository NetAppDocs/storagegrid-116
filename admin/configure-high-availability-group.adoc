...
. Optionally, if any S3, Swift, administrative or tenant clients will access these VIPs from a different subnet, enter the gateway address. The gateway address must be within the VIP subnet.
+
