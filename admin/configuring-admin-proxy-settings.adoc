...
[.lead]
If you send AutoSupport messages using HTTP or HTTPS (see xref:specifying-protocol-for-autosupport-messages.adoc[Specify the protocol for AutoSupport messages]), you can configure a non-transparent proxy server between Admin Nodes and technical support (AutoSupport). 
