...
. If you are downloading a certificate that is part of a bundle, select the sub-tab for the certificate to download.
. Specify the certificate file name and download location. Save the file with the extension `.pem`.
+
For example: `storagegrid_certificate.pem`
...
. If you are copying a certificate that is part of a bundle, select the sub-tab for the certificate to copy.
