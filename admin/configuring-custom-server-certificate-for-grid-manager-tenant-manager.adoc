...
. Expand *Certificate details* to see the metadata for each certificate you uploaded. If there are multiple CA bundles, each certificate displays on its own tab.
+
...
. Expand  *Certificate details* to see information about the generated certificate.
