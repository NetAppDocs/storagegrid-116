...
. Select the certificate details to display detailed certificate information for each custom S3 and Swift API certificate that was uploaded. If there are multiple CA bundles, each certificate displays on its own tab.
+
...
. Select the certificate details to display detailed certificate information for the custom S3 and Swift API certificate that was generated.
