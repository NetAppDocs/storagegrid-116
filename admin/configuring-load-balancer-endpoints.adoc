...
* If S3 tenants will use S3 Select, you are configuring an HA group that uses SG100 or SG1000 appliance or VMware-based software nodes for the endpoint. HA groups are not required, but are recommended when using S3 Select.
