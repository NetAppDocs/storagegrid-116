...
You can copy the first SP connection to create the SP connections you need for each Admin Node in your grid. 
...
. Enter the new Connection ID and Connection Name for the copy, so the new metadata can be used. 
