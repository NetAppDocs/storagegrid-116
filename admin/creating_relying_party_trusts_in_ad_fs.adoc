...
These instructions apply to AD FS 4.0, which is included with Windows Server 2016. If you are using a different version of AD FS, you will notice slight differences in the procedure. See the Microsoft AD FS documentation if you have questions.
