...
* If you plan to update the site selected for a KMS, you must have reviewed the xref:kms_considerations_for_changing_for_site.adoc[considerations for changing the KMS for a site].
