...
The following table shows how StorageGRID calculates the allowed metadata space for different Storage Nodes.

[cols="1a,1a,2a,2a" grid="rows"]
|===

4+^|*Allowed metadata space, based on memory size on Storage Node*
