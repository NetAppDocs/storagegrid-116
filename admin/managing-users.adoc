...
+
If you have not yet created groups, you can save the user without selecting groups. You can then select this user on the Groups page. 
+
...
|.. Select the user name to display the details.
.. Select the Access tab.
.. Select *Yes* to prevent the user from signing in to the Grid Manager or the Grid Management API, or select *No* to allow the user to sign in.
.. Select *Save changes*.
...
.. Select the link after a group name to view the group's details in a new browser tab.
