...
sidebar: sidebar
keywords: e-series, santricity system manager, autosupport, asup, appliance
...
NOTE: You have SANtricity firmware 8.70 or higher to access SANtricity System Manager using the Grid Manager.
...
xref:configuring-admin-proxy-settings.adoc[Configure Admin proxy settings]
