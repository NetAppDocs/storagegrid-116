...
NOTE: This procedure is only for configuring a StorageGRID proxy server for E-Series AutoSupport messages. For additional details on E-Series AutoSupport configuration, see the https://docs.netapp.com/us-en/e-series/index.html[NetApp E-Series and SANtricity Documentation^].
