---
permalink: admin/task_creating_a_high_availability_group.html
sidebar: sidebar
keywords: 
...
. In the Virtual IP Addresses section of the page, enter one to 10 virtual IP addresses for the HA group. Click the plus sign (image:../media/plus_sign_black_on_white.png[Plus Sign]) to add multiple IP addresses.
+
