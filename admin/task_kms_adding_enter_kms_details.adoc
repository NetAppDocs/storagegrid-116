---
permalink: admin/task_kms_adding_enter_kms_details.html
sidebar: sidebar
keywords: 
...
. If you are using a KMS cluster, select the plus sign image:../media/plus_sign_black_on_white.png[Icon Plus Sign] to add a hostname for each server in the cluster.
. Select *Next*.
+
