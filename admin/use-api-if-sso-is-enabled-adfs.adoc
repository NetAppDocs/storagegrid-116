...
summary: 'If you have configured and enabled single sign-on (SSO) and you use Active Directory Federated Services (AD FS) as the SSO provider, you must issue a series of API requests to obtain an authentication token that is valid for the Grid Management API or the Tenant Management API.'
---
...
[.lead]
If you have xref:../admin/configuring-sso.adoc[configured and enabled single sign-on (SSO)] and you use Active Directory Federated Services (AD FS) as the SSO provider, you must issue a series of API requests to obtain an authentication token that is valid for the Grid Management API or the Tenant Management API.
