...
.Azure
--
.. Enter the *Provider name* for the identity provider, exactly as it appears in Azure.
...
.. Enter the *Base domain* for the identity provider, exactly as it appears in Ping Federate.
