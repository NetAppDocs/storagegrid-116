---
permalink: admin/using_api_if_sso_is_enabled.html
sidebar: sidebar
keywords:
summary: 'If single sign-on (SSO) has been enabled for your StorageGRID system, you cannot use the standard Authenticate API requests to sign in to and sign out of the Grid Management API or the Tenant Management API.'
---
