---
permalink: admin/what_storage_node_is.html
sidebar: sidebar
keywords:
summary: ''
---
...
You can use the Diagnostics page to obtain additional information on the current state of your grid. See xref:../monitor/running_diagnostics.html.adoc[Running diagnostics].
