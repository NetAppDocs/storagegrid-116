...
xref:adding-storage-capacity.adoc[Add storage capacity]
...
* xref:vmware-adding-storage-volumes-to-storage-node.adoc[VMware: Add storage volumes to a Storage Node]

* xref:linux-adding-direct-attached-or-san-volumes-to-storage-node.adoc[Linux: Add direct-attached or SAN volumes to a Storage Node]
