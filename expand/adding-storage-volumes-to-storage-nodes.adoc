...
NOTE: These instructions apply to software-based Storage Nodes only. See the xref:../sg6000/index.adoc[installation and maintenance instructions for the SG6060 appliance] to learn how to add storage volumes to SG6060 by installing expansion shelves. Other appliance Storage Nodes cannot be expanded.
