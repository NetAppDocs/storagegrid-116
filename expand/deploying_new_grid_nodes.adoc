---
permalink: expand/deploying_new_grid_nodes.html
sidebar: sidebar
...
+
xref:../vmware/deploying_storagegrid_node_as_virtual_machine.adoc[Deploying a StorageGRID node as a virtual machine]
...
* You have a service laptop with a xref:../admin/web_browser_requirements.adoc[supported web browser].
