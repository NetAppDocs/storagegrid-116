...
* xref:adding-metadata-capacity.adoc[Add metadata capacity]
* xref:adding-grid-nodes-to-add-capabilities.adoc[Add grid nodes to add capabilities to your system]
* xref:adding-new-site.adoc[Add a new site]
