...
Similarly, when higher priority interfaces become available again, the VIP addresses are automatically moved to the highest priority interface available. 
