...
sidebar: sidebar
keywords: StorageGRID, fabricPool, high availability group, HA group, create, creating, virtual IP, VIP, preferred master, backup interface
...
xref:../admin/index.adoc[Administer StorageGRID] > Managing high availability groups
