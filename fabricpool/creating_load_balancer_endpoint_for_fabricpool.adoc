...
.About this task
For details about this task, see:

xref:../admin/configuring_load_balancer_endpoints.adoc[Configuring load balancer endpoints].
...
xref:../network/network_port_reference.adoc[Network port reference] > Network port reference
