---
permalink: fabricpool/task_creating_a_traffic_classification_policy_for_fabricpool.html
sidebar: sidebar
keywords: 
...
http://docs.netapp.com/sgws-115/topic/com.netapp.doc.sg-admin/home.html[Administering StorageGRID] > Managing traffic classification policies
