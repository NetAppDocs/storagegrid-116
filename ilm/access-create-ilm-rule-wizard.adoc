...
* If you are creating replicated copies, you have configured any storage pools or Cloud Storage Pools you plan to use. See xref:configuring-storage-pools.adoc[Configure storage pools] and xref:using-cloud-storage-pools.adoc[Use Cloud Storage Pools].
* If you are creating erasure-coded copies, you have configured an Erasure Coding profile. See xref:configuring-erasure-coding-profiles.adoc[Configure Erasure Coding profiles].
