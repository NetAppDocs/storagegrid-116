...
* If you are creating replicated copies, you have configured any storage pools or Cloud Storage Pools you plan to use. See xref:creating-storage-pool.adoc[Create storage pool] and xref:creating-cloud-storage-pool.adoc[Create a Cloud Storage Pool].
