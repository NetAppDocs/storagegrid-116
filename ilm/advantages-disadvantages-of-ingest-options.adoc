...
NOTE: Before selecting a consistency level, read the full description of these settings in the instructions for creating xref:../s3/index.adoc[S3]
 or xref:../swift/index.adoc[Swift] client applications. You should understand the benefits and limitations before changing the default value.
