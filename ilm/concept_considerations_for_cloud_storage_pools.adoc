---
permalink: ilm/concept_considerations_for_cloud_storage_pools.html
sidebar: sidebar
keywords: 
...
xref:task_creating_a_cloud_storage_pool.adoc[Creating a Cloud Storage Pool]

xref:task_s3_authentication_details_for_cloud_storage_pool.adoc[S3: Specifying authentication details for a Cloud Storage Pool]

xref:task_c2s_s3_authentication_details_for_cloud_storage_pool.adoc[C2S S3: Specifying authentication details for a Cloud Storage Pool]

xref:task_azure_authentication_details_for_cloud_storage_pool.adoc[Azure: Specifying authentication details for a Cloud Storage Pool]
