---
permalink: ilm/concept_example_2_ilm_rules_and_policy_for_ec_object_size_filtering.html
sidebar: sidebar
keywords: 
summary: ''
---
...
|===
image:../media/ilm_rule_2_for_example_2_two_replicated_copies.png[Example ILM Rule 2 for Example 2 - Two Replicated Copies]
