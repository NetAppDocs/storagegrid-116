---
permalink: ilm/concept_example_5_ilm_rules_and_policy_for_strict_ingest_behavior.html
sidebar: sidebar
keywords: 
summary: ''
---
...
|===
image:../media/ilm_rule_2_for_example_5_two_copies_2_data_centers.png[ILM Rule 2 for Example 5 - 2 Copies 2 Data Centers]
