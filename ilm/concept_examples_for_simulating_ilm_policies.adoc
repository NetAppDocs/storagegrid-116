---
permalink: ilm/concept_examples_for_simulating_ilm_policies.html
sidebar: sidebar
keywords: 
summary: ''
---
...
. For each rule in the policy, view the rule settings by clicking the rule name or the more details icon image:../media/nms_more_details_icon.gif[more details icon] on any dialog box where the rule is displayed.
...
a|
 .. Select the proposed policy, and click *Edit*.
 .. Click the delete icon image:../media/nms_delete_icon_new.gif[delete icon] to remove the incorrect rule, and click *Save*.
 .. Select *ILM* > *Rules*.
