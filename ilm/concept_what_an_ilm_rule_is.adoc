---
permalink: ilm/concept_what_an_ilm_rule_is.html
sidebar: sidebar
keywords: 
...
image::../media/example_ilm_rule_2_copies_tenant_a.png[Example ILM Rule 2 Copies Tenant A]
...
xref:concept_what_a_cloud_storage_pool_is.adoc[What a Cloud Storage Pool is]

xref:concept_how_objects_are_stored_replication_erasure_coding.adoc[How objects are stored (replication or erasure coding)]
