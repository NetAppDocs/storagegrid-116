...
image::../media/policy_2_rule_1_ec_objects_adv_filtering.png[ILM rule 1 for example 2: Use EC for all objects larger than 1 MB]
...
+
image::../media/policy_2_configured_policy.png[ILM policy for example 2: Use EC for objects larger than 1 MB]
