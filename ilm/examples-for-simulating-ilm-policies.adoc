...
sidebar: sidebar
keywords:
summary: 'These examples show how you can verify ILM rules by simulating the ILM policy before activating it.'
---
...
* The third rule is the default rule and does not include any filters and does not use the Noncurrent reference time.
