...
a|
Used for C2S S3 only. Go to link:c2s_s3_authentication_details_for_cloud_storage_pool.md#[C2S S3: Specifying authentication details for a Cloud Storage Pool].
|===
