---
permalink: ilm/task_configuring_regions_optional_and_s3_only.html
sidebar: sidebar
keywords: 
...
. To add a region:
 .. Click the insert icon image:../media/plus_sign_black_on_white.gif[insert icon] to the right of the last entry.
...
. To remove an unused region, click the delete icon image:../media/nms_delete_icon_new.gif[delete icon].
+
