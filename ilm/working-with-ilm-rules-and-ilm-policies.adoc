...
. Complete the pages of the Edit ILM Rule wizard, following the steps for xref:access-create-ilm-rule-wizard.adoc[creating an ILM rule] and xref:using-advanced-filters-in-ilm-rules.adoc[using advanced filters], as necessary.
+
