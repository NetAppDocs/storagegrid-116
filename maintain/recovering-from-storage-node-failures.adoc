...
|link:recovering_storage_node_that_has_been_down_more_than_15_days.adoc[Recover Storage Node down more than 15 days]
|This procedure is required to ensure Cassandra database integrity.

|An appliance Storage Node has failed.
|link:recovering_storagegrid_appliance_storage_node.adoc[Recover appliance Storage Node]
...
|link:recovering_from_system_drive_failure.adoc[Recover from system drive failure]
