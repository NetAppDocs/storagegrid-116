...
----
+
*** To view the estimated time to completion and the completion percentage for the current job, select *SUPPORT* > *Metrics*. Then, select *EC Overview* in the Grafana section. Look at the *Grid EC Job Estimated Time to Completion* and *Grid EC Job Percentage Completion* dashboards.
