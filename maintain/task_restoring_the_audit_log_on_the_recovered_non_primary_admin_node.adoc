---
permalink: maintain/task_restoring_the_audit_log_on_the_recovered_non_primary_admin_node.html
sidebar: sidebar
keywords: 
...
. Copy the preserved audit log files to the recovered Admin Node: `scp admin@grid_node_IP:/var/local/tmp/saved-audit-logs/YYYY* .`
+
