---
permalink: maintain/task_starting_software_installation_on_a_services_appliance_recovery.html
sidebar: sidebar
keywords: 
...
+
If the version of software that is ready to install is correct, skip ahead to step <<STEP_695A8129BE704D9C9C31E9D101B9E171,#STEP_695A8129BE704D9C9C31E9D101B9E171>>.
