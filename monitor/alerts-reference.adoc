...
. After resolving any storage issues, perform an xref:verifying-object-integrity.adoc#What is object existence check?[object existence check] to determine if any replicated copies are missing.
