...
. (OPTIONAL) If you previously used the Grid Manager API to provide a server certificate for certificate validation, upload the updated server certificate using the API.
