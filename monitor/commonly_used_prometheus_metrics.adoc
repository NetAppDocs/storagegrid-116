---
permalink: monitor/commonly_used_prometheus_metrics.html
sidebar: sidebar
keywords: 
...
a|
The total number of objects this service detects as missing from the StorageGRID system. Action should be taken to determine the cause of the loss and if recovery is possible.xref:troubleshooting_storagegrid_system.adoc[Troubleshooting lost and missing object data]
