...
a|
The total number of objects this service detects as missing from the StorageGRID system. Action should be taken to determine the cause of the loss and if recovery is possible.link:troubleshooting_storagegrid_system.md#[Troubleshooting lost and missing object data]
