...
xref:alert-rule-overview.adoc[Alert rule overview]
...
xref:email-alert-notifications.adoc[Set up email notifications for alerts]
...
a|
Select *Configuration* > *Monitoring* > *SNMP Agent*. xref:using-snmp-monitoring.adoc[Use SNMP monitoring]
