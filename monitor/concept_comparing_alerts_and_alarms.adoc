---
permalink: monitor/concept_comparing_alerts_and_alarms.html
sidebar: sidebar
keywords: 
...
link:concept_managing_alerts.md#[Viewing alert rules]

a|
Alarms are triggered when a StorageGRID attribute reaches a threshold value.

link:concept_managing_alarms.md#[Alarm triggering logic (legacy system)]
...
link:reference_alerts_reference.md#[Alerts reference]

a|
You can learn about an alarm by clicking the attribute name, or you can search for an alarm code in the StorageGRID documentation.link:reference_alarms_reference.md#[Alarms reference (legacy system)]
...
a|
Select *Support* > *Alarms (legacy)* > *Historical Alarms*. link:concept_managing_alarms.md#[Reviewing historical alarms and alarm frequency (legacy system)]
...
link:concept_managing_alerts.md#[Managing alerts]

a|
Select *Support*. Then, use the options in the *Alarms (legacy)* section of the menu.

link:concept_managing_alarms.md#[Managing alarms (legacy system)]
...
link:concept_managing_alerts.md#[Managing alert notifications]

a|
Select *Support* > *Alarms (legacy)* > *Legacy Email Setup*. link:concept_managing_alarms.md#[Configuring notifications for alarms (legacy system)]

a|
How do I manage SNMP notifications?
a|
Select *Configuration* > *Monitoring* > *SNMP Agent*. xref:concept_using_snmp_monitoring.adoc[Using SNMP monitoring]
...
link:concept_managing_alarms.md#[Suppressing alarm notifications for a mailing list (legacy system)]
...
link:concept_managing_alarms.md#[Suppressing email notifications system wide]
...
link:concept_managing_alerts.md#[Editing an alert rule]

link:concept_managing_alerts.md#[Creating custom alert rules]
...
link:concept_managing_alerts.md#[Disabling an alert rule]
