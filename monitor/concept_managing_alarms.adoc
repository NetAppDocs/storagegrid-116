---
permalink: monitor/concept_managing_alarms.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:concept_managing_alarms.md#[Viewing Default alarms (legacy system)]

link:concept_managing_alarms.md#[Disabling a Default alarm (legacy system)]

link:concept_managing_alarms.md#[Creating Global Custom alarms (legacy system)]

link:concept_managing_alarms.md#[Disabling Global Custom alarms (legacy system)]
...
. Click the arrow image:../media/nms_right_arrow_icon.gif[Arrow icon] or press *Enter*.
+
 ...
 ** To add a new alarm, click *Edit*image:../media/nms_edit_icon.gif[edit icon] (if this is the first entry) or *Insert*image:../media/nms_insert_icon.gif[insert icon].
+
...
Specify four characters or use wildcards (for example, A??? or AB*). Asterisks (*) represent multiple characters, and question marks (?) represent a single character.
  ...
  ... Click the arrow image:../media/nms_right_arrow_icon.gif[right arrow icon], or press *Enter*.
  ... In the list of results, click *Copy*image:../media/nms_copy_icon.gif[copy icon] next to the alarm you want to modify.
+
...
+
To display information about the attribute, click *Info*image:../media/nms_info_icon.gif[information icon] next to the attribute's name.
a|
Severity
a|
...
Actions
a|
Control buttons to:    image:../media/nms_edit_icon.gif[edit icon] Edit a row
+
image:../media/nms_insert_icon.gif[insert icon] Insert a row
+
image:../media/nms_delete_icon.gif[delete icon] Delete a row
+
image:../media/nms_drag_and_drop_icon.gif[drag and drop icon] Drag-and-drop a row up or down
+
image:../media/nms_copy_icon.gif[copy icon] Copy a row
+
|===
...
link:concept_managing_alarms.md#[Configuring email server settings for alarms (legacy system)]
...
. From the search results table, click the Edit icon image:../media/nms_edit_icon.gif[edit icon] for the alarm you want to disable.
+
...
. Select *Support* > *Alarms (legacy)* > *Global Alarms*.
. In the Global Custom Alarms table, click *Edit*image:../media/nms_edit_icon.gif[edit icon] next to the alarm you want to disable.
. Unselect the *Enabled* check box.
+
...
link:concept_managing_alarms.md#[Disabling alarms (legacy system)]
...
link:concept_managing_alarms.md#[Configuring email notifications for alarms (legacy system)]
...
. Click *Edit*image:../media/nms_edit_icon.gif[edit icon] (or *Insert*image:../media/nms_insert_icon.gif[insert icon] if this is not the first template).
+
...
. Click *Edit*image:../media/nms_edit_icon.gif[edit icon] (or *Insert*image:../media/nms_insert_icon.gif[insert icon] if this is not the first mailing list).
+
...
link:concept_managing_alarms.md#[Creating alarm email templates (legacy system)]
...
. Click *Edit*image:../media/nms_edit_icon.gif[edit icon] (or *Insert*image:../media/nms_insert_icon.gif[insert icon] if this is not the first notification).
...
link:concept_managing_alarms.md#[Creating mailing lists for alarm notifications (legacy system)]

link:concept_managing_alarms.md#[Types of alarm notifications (legacy system)]
...
. Select *Support* > *Alarms (legacy)* > *Legacy Email Setup*.
. From the Email menu, select *Notifications*.
. Click *Edit*image:../media/nms_edit_icon.gif[Edit icon] next to the mailing list for which you want to suppress notifications.
