---
permalink: monitor/concept_troubleshooting_a_storagegrid_system.html
sidebar: sidebar
keywords: 
summary: ''
---
...
* link:concept_troubleshooting_a_storagegrid_system.md#[Creating a timeline of recent changes]
...
* link:concept_managing_alarms.md#[Reviewing historical alarms and alarm frequency (legacy system)]
...
* link:concept_viewing_the_events_tab.md#[Viewing the Events tab]
* link:concept_monitoring_events.md#[Monitoring events]
...
* link:concept_using_charts_and_reports.md#[Using charts and reports]
...
* link:concept_troubleshooting_a_storagegrid_system.md#[Establishing baselines]
...
* link:task_monitoring_put_and_get_performance.md#[Monitoring PUT and GET performance]
...
* link:concept_reviewing_audit_messages.md#[Reviewing audit messages]
...
* link:task_monitoring_object_verification_operations.md#[Monitoring object verification operations]
* link:concept_troubleshooting_a_storagegrid_system.md#[Confirming object data locations]
...
* link:task_collecting_log_files_and_system_data.md#[Collecting log files and system data]
* link:task_manually_triggering_an_autosupport_message.md#[Manually triggering an AutoSupport message]
* link:task_reviewing_support_metrics.md#[Reviewing support metrics]
...
link:concept_troubleshooting_a_storagegrid_system.md#RECENT_CHANGES[concept_troubleshooting_a_storagegrid_system.md#RECENT_CHANGES]
...
Problem statement
a|
What are the problem symptoms? When did the problem start? Does it happen consistently or intermittently? If intermittently, what times has it occurred?link:concept_troubleshooting_a_storagegrid_system.md#[Defining the problem]
...
a|
Collect baseline information regarding ingest operations, retrieval operations, and storage consumption. link:concept_troubleshooting_a_storagegrid_system.md#[Establishing baselines]
...
a|
Create a timeline that summarizes any recent changes to the system or its environment.link:concept_troubleshooting_a_storagegrid_system.md#[Creating a timeline of recent changes]
...
link:concept_troubleshooting_a_storagegrid_system.md#[Defining the problem]

link:concept_troubleshooting_a_storagegrid_system.md#[Assessing the risk and impact on the system]

link:concept_troubleshooting_a_storagegrid_system.md#[Collecting data]

link:concept_troubleshooting_a_storagegrid_system.md#[Analyzing data]
...
link:concept_troubleshooting_a_storagegrid_system.md#[What background verification is]

link:concept_troubleshooting_a_storagegrid_system.md#[What foreground verification is]
...
link:concept_troubleshooting_a_storagegrid_system.md#[Investigating lost objects]

link:concept_troubleshooting_a_storagegrid_system.md#[Resetting lost and missing object counts]
...
+
link:concept_troubleshooting_a_storagegrid_system.md#[Searching for and restoring potentially lost objects]
...
....
    [Searching for and restoring potentially lost objects](concept_troubleshooting_a_storagegrid_system.md#)
...
NOTE: Always enclose the object file path in single quotes in commands to escape any special characters.
  ...
  *** If the object path is found, continue with step link:concept_troubleshooting_a_storagegrid_system.md#STEP_RESTORE[concept_troubleshooting_a_storagegrid_system.md#STEP_RESTORE]. You can attempt to restore the found object back to StorageGRID.
...
----
+
Continue with step link:concept_troubleshooting_a_storagegrid_system.md#STEP_VERIFY[concept_troubleshooting_a_storagegrid_system.md#STEP_VERIFY].
...
link:concept_troubleshooting_a_storagegrid_system.md#[Troubleshooting the Storage Status (SSTS) alarm]
...
----
 ...
 .. Make sure the timestamp of this message is the time when you attempted restarting Cassandra as instructed in step link:concept_troubleshooting_a_storagegrid_system.md#STEP_6A4A25E2BE2649DAB476DB900C8B864F[3].
+
...
. Repeat steps link:concept_troubleshooting_a_storagegrid_system.md#STEP_711E539DD37B4B67B1007A52C9E16410[concept_troubleshooting_a_storagegrid_system.md#STEP_711E539DD37B4B67B1007A52C9E16410] and link:concept_troubleshooting_a_storagegrid_system.md#STEP_E8986AC5D5004199BAC0553A2C005F9F[concept_troubleshooting_a_storagegrid_system.md#STEP_E8986AC5D5004199BAC0553A2C005F9F] to review the logs on the Storage Nodes.
...
link:concept_troubleshooting_a_storagegrid_system.md#[Troubleshooting the Grid Network MTU mismatch alert]
