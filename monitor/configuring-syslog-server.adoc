...
+
For security events, if you select *Passthrough*, the severity is 'xxxx'
...
.. If you do not want to use the passthrough value, select the severity value between 0 and 7.
...
+
For security events, if you select *Passthrough*, the facility sent to the external syslog server is 'xxxx'
