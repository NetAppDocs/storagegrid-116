...
Your StorageGRID audit information is not sent to the external syslog server until you select a destination that includes the external syslog server. See xref:../monitor/configure-audit-messages.adoc#[Configure audit messages and log destinations] to send your audit information to your newly configured external syslog server. 
