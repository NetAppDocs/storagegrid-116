...
* To learn about the commonly used metrics: xref:commonly-used-prometheus-metrics.adoc[Commonly used Prometheus metrics].

* To learn about using the Grid Management API: xref:../admin/index.adoc[instructions for administering StorageGRID]. 

* For details on the syntax of Prometheus queries: https://prometheus.io/docs/querying/basics/[Prometheus: Query basics^].
...
+
To see available metrics and to test Prometheus expressions, select the help icon image:../media/icon_nms_question.gif[question mark icon] and follow the link to the Metrics section of the Grid Management API. 
