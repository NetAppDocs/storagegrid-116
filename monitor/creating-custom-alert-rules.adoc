...
* You are familiar with the commonly used metrics: xref:commonly-used-prometheus-metrics.adoc[Commonly used Prometheus metrics]

* You understand the syntax of Prometheus queries: https://prometheus.io/docs/querying/basics/[Prometheus: Query basics^]
