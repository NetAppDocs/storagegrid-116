---
permalink: monitor/investigating_lost_objects.html
sidebar: sidebar
keywords: lost objects, investigating
...
xref:troubleshooting_storagegrid_system.adoc[Searching for and restoring potentially lost objects]
