...
NOTE: While the xref:alarms-reference.adoc[legacy alarm system] continues to be supported, the xref:alerts-reference.adoc[alert system] offers significant benefits and is easier to use.
