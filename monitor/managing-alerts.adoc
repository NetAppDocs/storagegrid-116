...
+
To see available metrics and to test Prometheus expressions, click the help icon image:../media/icon_nms_question.png[question mark icon] and follow the link to the Metrics section of the Grid Management API.
+
