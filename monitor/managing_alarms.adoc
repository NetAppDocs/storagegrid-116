...
xref:managing_alarms.adoc[Viewing Default alarms (legacy system)]
...
xref:managing_alarms.adoc[Creating alarm email templates (legacy system)]
...
xref:managing_alarms.adoc[Types of alarm notifications (legacy system)]
