...
* xref:comparing_alerts_and_alarms.adoc[Comparing alerts and alarms]
* xref:managing_alerts.adocmanaging_alerts[Managing alerts]
* xref:managing_alarms.adocmanaging_alarms[Managing alarms (legacy system)]
