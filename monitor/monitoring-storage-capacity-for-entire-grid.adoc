...
image::../media/storage_capacity_used.gif[Dashboard Free or Used capacity chart]
 ...
 .. Click the chart icon image:../media/icon_chart_new_for_11.5.png[Chart Icon] for the overall chart or for an individual data center to view a graph showing capacity usage over time.
+
