 ...
 ** For a server certificate, see the steps for xref:../admin/configuring-custom-server-certificate-for-grid-manager-tenant-manager.adoc#upload-a-custom-management-interface-certificate[configuring a custom server certificate for the Grid Manager and the Tenant Manager].
 ...
 ** If you are attempting to connect to StorageGRID using a domain name:
  ...
  ... In the instructions for administering StorageGRID, see the steps for xref:../admin/configuring-custom-server-certificate-for-grid-manager-tenant-manager.adoc#upload-a-custom-management-interface-certificate[configuring a custom server certificate for the Grid Manager and the Tenant Manager].
