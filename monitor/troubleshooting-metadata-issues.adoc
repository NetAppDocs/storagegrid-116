...
sidebar: sidebar
keywords: troubleshoot metadata
...
You can xref:monitoring-object-metadata-capacity-for-each-storage-node.adoc[Monitor object metadata capacity for each Storage Node] to help you anticipate errors and correct them before they occur.
