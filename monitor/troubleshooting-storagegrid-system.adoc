...
* xref:troubleshooting-storagegrid-system.adoc[Create a timeline of recent changes]
...
* xref:viewing-events-tab.adoc[View the Events tab]
...
* xref:troubleshooting-storagegrid-system.adoc[Establish baselines]
...
* xref:troubleshooting-storagegrid-system.adoc[Confirm object data locations]
* xref:troubleshooting-storagegrid-system.adoc[Verify object integrity]
