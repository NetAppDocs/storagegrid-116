...
+
Each alert is mapped to one of three trap types based on severity level of the alert: activeMinorAlert, activeMajorAlert, and activeCriticalAlert. For descriptions of the alerts that can trigger one of these traps, see the xref:alerts-reference.adoc[Alerts reference].
