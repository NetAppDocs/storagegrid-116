...
Object existence check is a user-initiated process that checks if all expected replicated copies of objects and copies of erasure-coded fragments exist on a Storage Node. Object existence check is used to verify the integrity of a storage device.
