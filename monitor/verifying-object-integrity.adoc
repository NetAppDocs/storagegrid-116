...
.. When you are ready to rerun the jobs, select *Rerun job*.

+
The Active job tab appears. All the jobs you selected are rerun as one job at a consistency control of strong-site. A *Linked jobs* field in the Details section lists the job IDs for the original jobs.
