...
* To view capacity trends over a date range, click the chart icon image:../media/icon_chart_new_for_11.5.png[Chart Icon] for the overall grid, or for a data center site.
...
* To view trends over a date range, click the chart icon image:../media/icon_chart_new_for_11.5.png[Chart Icon] to the right of the S3 or Swift protocol rate.
