...
For more details on viewing the information accessible from the SANtricity System Manager tab, see the https://docs.netapp.com/us-en/e-series/index.html[NetApp E-Series and SANtricity documentation^].
