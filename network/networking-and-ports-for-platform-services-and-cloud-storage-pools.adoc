...
As described in xref:../admin/manage-platform-services-for-tenants.adoc[Manage platform services for S3 tenant accounts] and xref:../tenant/what-platform-services-are.adoc[What are platform services], platform services include external services that provide search integration, event notification, and CloudMirror replication.
