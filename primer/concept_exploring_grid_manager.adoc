---
permalink: primer/concept_exploring_grid_manager.html
sidebar: sidebar
keywords: 
summary: ''
---
...
For an explanation of the information on each panel, click the help icon image:../media/nms_question_icon.gif[question mark icon] for that panel.
...
link:concept_storagegrid_architecture_and_network_topology.md#[Grid nodes and services]

xref:concept_storagegrid_attributes.adoc[StorageGRID attributes]

link:[Monitoring alarms (legacy system)]

link:concept_using_storagegrid_support_options.md#[Collecting StorageGRID logs]

link:concept_using_storagegrid_support_options.md#[Configuring AutoSupport]

link:concept_using_storagegrid_support_options.md#[Using metrics and running diagnostics]
