...
* If you are using virtual hosts, you have read the xref:considerations-and-recommendations-for-mac-address-cloning.adoc[considerations and recommendations for MAC address cloning] before configuring the host network.
