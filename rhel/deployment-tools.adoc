...
If you are interested in automating all or part of your StorageGRID deployment, review xref:automating-installation.adoc[Automating the installation] before beginning the installation process.