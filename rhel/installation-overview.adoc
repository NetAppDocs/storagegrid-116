 ...
 ** On the servers you have prepared:
  ...
  *** Install the Docker or Podman container engine
...
These instructions recommend a standard approach for deploying and configuring a StorageGRID system. Also see the information about the following alternative approaches:
...
xref:planning-and-preparation.adoc[Plan and prepare]

xref:deploying-virtual-grid-nodes.adoc[Deploy virtual grid nodes]

xref:automating-installation.adoc[Automate the installation]
