...
a|    
Retreive the default retention period for a bucket using a GET Bucket Policy request.
...
s3:object-lock-remaining-retention-days
a|    
Set the default retention period during new bucket creation using one of the following requests:
...
s3:object-lock-remaining-retention-days
a|    
Set the default retention period for an existing bucket using a PUT Object Retention request.
