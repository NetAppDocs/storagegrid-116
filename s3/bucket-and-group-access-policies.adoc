...
xref:bucket-and-group-access-policies.adoc[Specify variables in policy]
...
xref:bucket-and-group-access-policies.adoc[Create policies requiring special handling]
...
xref:bucket-and-group-access-policies.adoc[Use PutOverwriteObject permission]
