---
permalink: s3/concept_s3_operations_tracked_in_the_audit_logs.html
sidebar: sidebar
keywords: 
...
link:concept_s3_rest_api_supported_operations_and_limitations.md#[Operations on objects]
