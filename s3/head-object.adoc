...
The `partNumber` request parameter allows you to perform a HEAD operation on a specific part of a multipart or segmented object. 

The `x-amz-mp-parts-count` response element indicates how many parts an object has.
