...
xref:automating-installation-configuration-appliance-nodes-configure-sga-py-script.adoc[Automate installation and configuration of appliance nodes using the configure-sga.py script]
