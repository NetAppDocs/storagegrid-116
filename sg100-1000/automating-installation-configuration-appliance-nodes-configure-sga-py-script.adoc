...
xref:automating-appliance-configuration-using-storagegrid-appliance-installer.adoc[Automate appliance configuration using the StorageGRID Appliance Installer]
