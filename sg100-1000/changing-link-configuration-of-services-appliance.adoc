...
---
= Change the link configuration of the services appliance
:icons: font
:imagesdir: ../media/
...
* xref:placing-appliance-into-maintenance-mode.adoc[Place the appliance in maintenance mode]. Putting a StorageGRID appliance into maintenance mode might make the appliance unavailable for remote access.
