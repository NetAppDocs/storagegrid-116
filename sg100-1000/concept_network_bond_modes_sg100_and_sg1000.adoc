---
permalink: sg100-1000/concept_network_bond_modes_sg100_and_sg1000.html
sidebar: sidebar
keywords: 
...
image::../media/aggregate_ports_sg100.png[SG100 aggregate port bond mode]

*SG1000 aggregate port bond mode*

image::../media/aggregate_ports_sg1000.png[SG1000 Aggregate Port Bond Mode]
