---
permalink: sg100-1000/concept_sg100_and_sg1000_appliances_overview.html
sidebar: sidebar
keywords: 
...
image::../media/front_with_ssds_sg1000.png[Front with SSDs SG100 and SG1000]

== Connectors on the rear of the SG100

This figure shows the connectors on the back of the SG100.

image::../media/rear_connectors_sg100.png[Rear Connectors SG100]
...
image::../media/rear_connectors_sg1000.png[Rear Connectors SG1000]
