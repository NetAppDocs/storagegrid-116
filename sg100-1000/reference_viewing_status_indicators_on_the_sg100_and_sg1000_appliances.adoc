---
permalink: sg100-1000/reference_viewing_status_indicators_on_the_sg100_and_sg1000_appliances.html
sidebar: sidebar
keywords: 
...
image::../media/front_indicators_sg6000_cn.gif[Front Indicators - SG1000]
