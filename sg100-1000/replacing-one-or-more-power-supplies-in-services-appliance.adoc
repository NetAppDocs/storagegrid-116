...
* You have xref:locating-controller-in-data-center.adoc[determined the physical location] in the data center of the controller with the power supply to be replaced.
