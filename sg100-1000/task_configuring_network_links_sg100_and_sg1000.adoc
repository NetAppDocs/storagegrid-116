---
permalink: sg100-1000/task_configuring_network_links_sg100_and_sg1000.html
sidebar: sidebar
keywords: 
...
*SG100 fixed port bond mode* image:../media/fixed_port_sg100.png[SG100 Fixed Port Bond Mode]

*SG1000 fixed port bond mode*

image::../media/fixed_port_sg1000.png[SG1000 Fixed Port Bond Mode]
...
image::../media/aggregate_ports_sg100.png[Aggregate Port Bond Mode SG100]

*SG1000 aggregate port bond mode*

image::../media/aggregate_ports_sg1000.png[Aggregate Port Bond Mode SG1000]
...
image::[Admin Network Ports Bonded SG100]

*SG1000 Admin Network ports bonded*

image::../media/bonded_management_ports_sg1000.png[Admin Network Ports Bonded SG1000]
...
+
*SG100 ports* image:../media/sg100_configuring_network_ports.png[SG100 rear connectors]
+
*SG1000 ports*
+
...
image:../media/network_link_configuration_fixed_sg1000.png[Network Link Configuration Fixed]
...
image:../media/network_link_configuration_aggregate_sg1000.png[Network Link Configuration Aggregate]
