---
permalink: sg100-1000/task_configuring_storagegrid_ip_addresses_sg100_and_sg1000.html
sidebar: sidebar
keywords: 
...
+
If you lose your connection to the StorageGRID Appliance Installer, re-enter the URL using the new static IP address you just assigned. For example, `+https://services_appliance_IP:8443+`
...
NOTE: The default route is not listed. If the Client Network is not enabled, the default route will use the Grid Network gateway.
  ...
  *** To add a subnet, click the insert icon image:../media/plus_sign_black_on_white.gif[insert icon] to the right of the last entry.
  *** To remove an unused subnet, click the delete icon image:../media/nms_delete_icon_new.gif[delete icon].
...
When you change the IP address, the gateway and list of subnets might also change.
+
If you lose your connection to the StorageGRID Appliance Installer, re-enter the URL using the new static IP address you just assigned. For example, `+https://services_appliance:8443+`
