...
* xref:setting-ip-address-for-e2700-controller.adoc[Set IP address for the E2700 controller]
* xref:adding-appliance-to-santricity-storage-manager.adoc[Add appliance to SANtricity Storage Manager]
* xref:setting-up-santricity-storage-manager.adoc[Set up SANtricity Storage Manager]
