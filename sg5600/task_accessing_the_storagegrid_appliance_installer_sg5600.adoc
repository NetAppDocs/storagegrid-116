---
permalink: sg5600/task_accessing_the_storagegrid_appliance_installer_sg5600.html
sidebar: sidebar
keywords: 
...
. If you were able to obtain either of the DHCP addresses:
 ...
 .. Enter this URL for the StorageGRID Appliance Installer: `+https://E5600SG_Controller_IP:8443+`
+
