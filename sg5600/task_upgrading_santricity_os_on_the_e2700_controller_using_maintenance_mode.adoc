---
permalink: sg5600/task_upgrading_santricity_os_on_the_e2700_controller_using_maintenance_mode.html
sidebar: sidebar
keywords: 
...
. Follow the instructions in the _E2700 and E5600 SANtricity Software and Firmware Upgrade Guide_ or the SANtricity Storage Manager online help, and upgrade the E2700 controller's firmware, NVSRAM, or both.
+
