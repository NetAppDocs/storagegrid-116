...
+
Do not use management port 2 (P2 on the E2800 and 0b on the E2800B) on the E2800 controller (the RJ-45 port on the right). This port is reserved for technical support.
