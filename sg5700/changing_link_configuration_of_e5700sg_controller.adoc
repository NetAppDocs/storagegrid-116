---
permalink: sg5700/changing_link_configuration_of_e5700sg_controller.html
sidebar: sidebar
keywords: 
...
+
NOTE: You might lose your connection if you made changes to the network or link you are connected through. If you are not reconnected within 1 minute, re-enter the URL for the StorageGRID Appliance Installer using one of the other IP addresses assigned to the appliance: +https://E5700SG_Controller_IP:8443+
+
