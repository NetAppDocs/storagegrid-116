...
[.lead]
Both the 12-drive SG5712 and SG5712X and the 60-drive SG5760 and SG5760X models of the StorageGRID appliance include an E5700SG controller and an E-Series E2800 storage controller. You should review the diagrams to learn the differences among the controllers.
...
There are two versions of the E2800 storage controller: E2800A and E2800B. The E2800A does not have a HIC, and the E2800B has a four-port HIC. The two controller versions have identical specifications and function except for the location of the interconnect ports. 
...
image::../media/e2800B_controller_with_callouts.png[Connectors on E2800B controller]
