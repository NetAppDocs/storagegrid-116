...
[.lead]
Both the 12-drive SG5712 and SG5712X and the 60-drive SG5760 and SG5760X models of the StorageGRID appliance include an E5700SG controller and an E-Series E2800 storage controller. You should review the diagrams to learn the differences between the controllers.
...
There are two versions of the E2800 storage controller: E2800A and E2800B. The two controller versions have identical specifications and function except for the location of the interconnect ports. 

The E2800 storage controller has the following specifications: 
