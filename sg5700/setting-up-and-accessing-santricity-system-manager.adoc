...
+
NOTE: If the StorageGRID Appliance Installer is not available or the login page does not appear, you must use the IP address of the storage controller. Access SANtricity System Manager by browsing to the storage controller IP: +
...
. [[config_hardware_alerts_sg5700,start=4]]Configure hardware alerts.
