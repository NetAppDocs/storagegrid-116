---
permalink: sg5700/task_accessing_the_storagegrid_appliance_installer_sg5700.html
sidebar: sidebar
keywords: 
...
. If you were able to obtain either of the DHCP addresses:
 ...
 .. Enter this URL for the StorageGRID Appliance Installer: `+https://E5700SG_Controller_IP:8443+`
+
