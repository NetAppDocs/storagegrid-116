---
permalink: sg6000/adding_expansion_shelf_to_deployed_sg6060.html
sidebar: sidebar
keywords: 
...
+
link:sg6060_installing_60_drive_shelves_into_cabinet_or_rack.adoc[SG6060: Installing 60-drive shelves into a cabinet or rack]

. Follow the instructions for installing the drives.
+
link:sg6060_installing_drives.adoc[SG6060: Installing the drives]
