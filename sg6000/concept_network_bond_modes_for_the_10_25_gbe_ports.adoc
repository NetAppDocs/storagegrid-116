---
permalink: sg6000/concept_network_bond_modes_for_the_10_25_gbe_ports.html
sidebar: sidebar
keywords: 
...
image::../media/fixed_port_sg6000_cn.gif[Fixed Port Bond Mode]
...
image::../media/aggregate_port_sg6000_cn.gif[Aggregate Port Bond Mode]
