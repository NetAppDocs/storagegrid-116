---
permalink: sg6000/concept_sg6060_overview.html
sidebar: sidebar
keywords: 
...
a|
Optional: Storage expansion shelves**Note:** Expansion shelves can be installed during initial deployment or added later.
