...
* xref:preparing-site-sg6000.adoc[Prepare site (SG6000)]
* xref:unpacking-boxes-sg6000.adoc[Unpack boxes (SG6000)]
* xref:obtaining-additional-equipment-and-tools-sg6000.adoc[Obtain additional equipment and tools (SG6000)]
