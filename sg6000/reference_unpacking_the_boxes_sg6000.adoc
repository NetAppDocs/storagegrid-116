---
permalink: sg6000/reference_unpacking_the_boxes_sg6000.html
sidebar: sidebar
keywords: 
...
+
image::../media/front_without_bezel_sg6000_cn.gif[SG6000-CN controller]
...
* *Two front bezels*
+
image::../media/front_bezels_for_table_sg6000.gif[Front Bezels]
...
+
image::../media/back_bracketstable_size.gif[Back brackets and cage nuts for SG5760]
