...
xref:setting-ip-addresses-for-storage-controllers-using-storagegrid-appliance-installer.adoc[Set IP addresses for the storage controllers using the StorageGRID Appliance Installer]
