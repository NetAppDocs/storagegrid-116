---
permalink: sg6000/task_accessing_the_storagegrid_appliance_installer_sg6000.html
sidebar: sidebar
keywords: 
...
+
image::../media/admin_network_port_sg6000_cn.gif[Admin Network port on the SG6000-CN controller]
...
+
image::../media/link_local_port_sg6000_cn.gif[Location of Management Port for SG6000-CN]
