---
permalink: sg6000/task_adding_an_expansion_shelf_to_a_deployed_sg6060.html
sidebar: sidebar
keywords: 
...
+
link:task_sg6060_installing_60_drive_shelves_into_a_cabinet_or_rack.md#[SG6060: Installing 60-drive shelves into a cabinet or rack]

. Follow the instructions for installing the drives.
+
link:task_sg6060_installing_the_drives.md#[SG6060: Installing the drives]
