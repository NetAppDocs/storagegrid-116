---
permalink: sg6000/task_configuring_network_links_sg6000.html
sidebar: sidebar
keywords: 
...
NOTE: If you are cloning an appliance node, configure network links for the target appliance for all links used by the source appliance node.
...
image::../media/fixed_port_sg6000_cn.gif[Image showing how the network ports on the SG6000-CN controller are bonded in fixed mode]
...
image::../media/aggregate_port_sg6000_cn.gif[Image showing how the network ports on the SG6000-CN controller are bonded in aggregate mode]
