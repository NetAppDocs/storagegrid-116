---
permalink: sg6000/task_deploying_an_appliance_storage_node.html
sidebar: sidebar
keywords: 
...
NOTE: If you are cloning an appliance node, continue following the process in recovery and maintenance.
...
NOTE: If you are performing an expansion or recovery operation, follow the appropriate instructions:
