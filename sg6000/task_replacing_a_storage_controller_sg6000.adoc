---
permalink: sg6000/task_replacing_a_storage_controller_sg6000.html
sidebar: sidebar
keywords: 
...
+
image::../media/labels_on_e2800_controller.gif[MAC and FRU labels on E2800 controller]
+
|===
...
| Item| Description
a|
        image:../media/legend_icon_01.gif[number 1]
a|
Internal Cache Active LED
a|
        image:../media/legend_icon_02.gif[number 2]
a|
Battery
|===
