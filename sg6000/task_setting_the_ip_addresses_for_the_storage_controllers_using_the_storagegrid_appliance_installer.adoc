---
permalink: sg6000/task_setting_the_ip_addresses_for_the_storage_controllers_using_the_storagegrid_appliance_installer.html
sidebar: sidebar
keywords: 
...
. From the client, enter the URL for the StorageGRID Appliance Installer: `+https://Appliance_Controller_IP:8443+`
+
...
+
When you connect to SANtricity System Manager, you will use the new static IP address as the URL: `+https://Storage_Controller_IP+`
