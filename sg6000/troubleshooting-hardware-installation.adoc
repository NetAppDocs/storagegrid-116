...
---
= Troubleshooting the hardware installation (SG6000)
:icons: font
:imagesdir: ../media/
...
xref:hardware-setup-appears-to-hang.adoc[Hardware setup appears to hang (SG6000)]

xref:troubleshooting-connection-issues.adoc[Troubleshooting connection issues (SG6000)]
