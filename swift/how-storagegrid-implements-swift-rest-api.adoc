...
StorageGRID also allows you to control consistency on a per container basis. You can change the consistency control to provide a balance between the availability of the objects and the consistency of those objects across different Storage Nodes and sites, as required by your application.
