---
permalink: swift/task_configuring_tenant_accounts_and_connections.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:task_configuring_tenant_accounts_and_connections.md#[Creating and configuring Swift tenant accounts]

link:concept_configuring_security_for_the_rest_api.md#[Configuring security for the REST API]
