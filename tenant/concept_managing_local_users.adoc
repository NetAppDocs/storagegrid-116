---
permalink: tenant/concept_managing_local_users.html
sidebar: sidebar
keywords: users,local users,managing local users
summary: ''
---
...
. Make changes to the user settings as needed.
 .. Change the user's full name as needed by selecting the full name or the edit icon image:../media/edit_icon_tm.png[Edit icon] in the Overview section.
+
