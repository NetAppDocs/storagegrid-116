...
*Note*: The maximum size for a single PUT Object operation is 5 GiB. You can use multipart upload for objects that are larger than 5 GiB, up to a maximum of 5 TiB (5,497,558,138,880 bytes).
