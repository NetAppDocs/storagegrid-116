...
Tenant accounts are created by a xref:../admin/index.adoc[StorageGRID grid administrator using the Grid Manager]. When creating a tenant account, the grid administrator specifies the following information:
...
After an xref:../admin/index.adoc[S3 tenant account is created], you can access the Tenant Manager to perform tasks such as the following:
...
After a xref:../admin/index.adoc[Swift tenant account is created], you can access the Tenant Manager to perform tasks such as the following:
