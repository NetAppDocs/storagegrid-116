...
From the top of the Grid Manager, select the help icon and select *API Documentation*. Then select *Go to private API documentation* to see the available operations.
