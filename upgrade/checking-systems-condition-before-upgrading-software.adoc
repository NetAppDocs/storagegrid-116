...
+
For information about specific alerts, see xref:../monitor/alerts-reference.adoc[alerts reference].
...
. Refer to the lists of internal and external ports in the 11.6 version of the xref:../network/index.adoc[networking guidelines], and ensure that all required ports are opened before you upgrade.
+
