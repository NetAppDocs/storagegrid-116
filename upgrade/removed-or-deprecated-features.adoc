...
To help you transition clients to using smaller object sizes in PUT Object and PUT Object - Copy requests, the *S3 PUT Object size too large* alert will be triggered in StorageGRID 11.6 if an S3 client attempts to upload an object that is too large.  
