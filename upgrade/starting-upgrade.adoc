...
. If you want to validate the condition of your system before you start the actual upgrade, select *Run Prechecks*. Wait for the prechecks to complete and resolve any precheck errors that are reported.
+
...
. After the primary Admin Node has been upgraded, clear your web browser's cache, sign back in.
+
...
. From the sidebar, select *MAINTENANCE* to open the new Maintenance menu.
