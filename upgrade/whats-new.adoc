...
** xref:../maintain/linux-adding-trunk-or-access-interfaces-to-node.adoc[Linux: Add trunk or access interface to a node]
** xref:../vmware/collecting-information-about-your-deployment-environment.adoc#client-network-information[Collect information about your deployment environment]
