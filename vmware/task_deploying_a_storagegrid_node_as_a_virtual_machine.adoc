---
permalink: vmware/task_deploying_a_storagegrid_node_as_a_virtual_machine.html
sidebar: sidebar
keywords: 
...
+
NOTE: If you are deploying a node as part of recovery operation, perform the instructions in step <<STEP_RECOVERY_STORAGE,#STEP_RECOVERY_STORAGE>> to add new virtual disks, reattach virtual hard disks from the failed grid node, or both.
+
