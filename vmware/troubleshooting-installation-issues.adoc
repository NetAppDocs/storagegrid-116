...
To learn how to access the log files, see the xref:../monitor/index[instructions for monitoring and troubleshooting StorageGRID]. For help troubleshooting appliance installation issues, see the installation and maintenance instructions for your appliances. If you need additional help, contact technical support.
